...
allfour <- as.formula("validate_true ~ (dkfz + sanger + smufin)*(wgs_tvaf + wgs_tvardepth + wgs_nvaf + wgs_nvardepth + varlen + cosmic + dbsnp + thousand_genomes + repeat_count + broad_snowman)")
nosmufin<- as.formula("validate_true ~ (dkfz + sanger)*(wgs_tvaf + wgs_tvardepth + wgs_nvaf + wgs_nvardepth + varlen + cosmic + dbsnp + thousand_genomes + repeat_count + broad_snowman)")
nobroad <- as.formula("validate_true ~ (dkfz + sanger + smufin)*(wgs_tvaf + wgs_tvardepth + wgs_nvaf  + wgs_nvardepth + varlen + cosmic + dbsnp + thousand_genomes + repeat_count )")
