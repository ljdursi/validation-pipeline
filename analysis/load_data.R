...
array4_sv_calls <- ingest_csv('array4_allcalls_sv.csv', sv_callers)
array3_sv_calls <- ingest_csv('array3_allcalls_sv.csv', sv_callers)
array2_sv_calls <- ingest_csv('array2_allcalls_sv.csv', sv_callers)
...
array4_svs <- ingest_csv('array4_sv.csv', sv_callers)
array3_svs <- ingest_csv('array3_sv.csv', sv_callers)
array2_svs <- ingest_csv('array2_sv.csv', sv_callers)
